"""Definition of Environment class that works as a state transition function."""
...
class Environment(BaseEnvironment):
    """
    The Environment is the state transition function in charge of stepping the walkers.
    ...
    def states_from_data(
        ...
        **kwargs,
        ...
        terminals = (
            tensor(terminals, dtype=dtype.bool)
...
class DiscreteEnv(Environment):
    ...
    # fmt: off
    def __init__(self, env: "plangym.core.PlanEnvironment", states_dtype: type = numpy.ubyte):  # noqa: F821 E501 fmt: on
        """
    ...
    def states_to_data(
        ...
        data = {"states": env_states.states, "actions": model_states.actions, "dt": dt}
        return data
    ...
    def make_transitions(
        ...
        """
        Step the underlying :class:`plangym.Environment`.

        We do this by calling the ``step_batch`` method of the ``plangym`` interface.
        """
