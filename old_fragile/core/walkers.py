...
class SimpleWalkers(BaseWalkers):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            env_state_params: Dictionary to instantiate the SwarmState of an :class:`Environment`.
            model_state_params: Dictionary to instantiate the SwarmState of a :class:`Model`.
    ...
    def env_states(self) -> StatesEnv:
        """Return the `SwarmState` class that contains the data used by the :class:`Environment`."""
        return self._env_states

    @property
    def model_states(self) -> StatesModel:
        """Return the `SwarmState` class that contains the data used by a Model."""
