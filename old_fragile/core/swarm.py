...
class Swarm(BaseSwarm):
    ...
    def report_progress(self):
        ...
        if self._ipython_mode and self._use_notebook_widget:
            ...
            html = html.replace("Walkers SwarmState", "<strong>Walkers SwarmState</strong>")
            html = html.replace("Model SwarmState", "<strong>Model SwarmState</strong>")
            html = html.replace("Environment SwarmState", "<strong>Environment Model</strong>")
            if self.tree is not None:
